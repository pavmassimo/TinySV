# The following code has been taken from: https://github.com/yistLin/dvector/blob/master/modules/dvector.py
# The same model has been used for testing the GE2E Loss in this work.
